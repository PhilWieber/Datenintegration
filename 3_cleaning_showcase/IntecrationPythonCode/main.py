...
import JSONManager.Rezept
import json

from SQLManager import SQL,SQLSendData,SQLGETData
...
if __name__ == '__main__':
   ...
   rezept = JSONManager.Rezept.getRezepts()
   print(type(rezept))
   SQLSendData.sendRezept(connection,rezept)
